...
import pt.isel.pdm.gomokuroyale.game.play.domain.board.BoardDraw
import pt.isel.pdm.gomokuroyale.game.play.domain.board.BoardOpen
import pt.isel.pdm.gomokuroyale.game.play.domain.board.BoardRun
import pt.isel.pdm.gomokuroyale.game.play.domain.board.BoardWin
import pt.isel.pdm.gomokuroyale.game.play.domain.board.Cell
import pt.isel.pdm.gomokuroyale.game.play.domain.board.Direction
import pt.isel.pdm.gomokuroyale.game.play.domain.board.Piece
import pt.isel.pdm.gomokuroyale.game.play.domain.board.cellsInDirection
import pt.isel.pdm.gomokuroyale.game.play.domain.board.countCellsForIsWin
import pt.isel.pdm.gomokuroyale.game.play.domain.board.isDraw
import pt.isel.pdm.gomokuroyale.game.play.domain.board.isWin

interface VariantLogic {
